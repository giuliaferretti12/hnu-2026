...
- Acquérir des connaissances historiques sur les origines du web et sur l’infrastructure d’Internet qui le sous-tend.
...
- Intégrer des requêtes API à son site 
...
- **12h30 - 13h30**
  ...
  - Atelier pratique : structurer son CV en html.
...
- **14h30 - 15h30**
  - Atelier pratique : mettre en forme son CV en ligne en utilisant HTML et CSS.
...
- **10h30 - 11h30**
  - Atelier pratique : création d'un jeu devinette simple en JavaScript, avec mise en forme en CSS.

#### Après-midi

- **12h30 - 13h30**
  - Les générateurs de sites statiques, une introduction
  - Un exemple simple avec le Crieur
  - Un exemple sémantiquement contrôlé avec Pandoc
  - Un exemple utilisé par une vaste communauté avec Eleventy

- **13h30 - 14h30**
  - Atelier Eleventy pt.1 : création d'un blog Eleventy _from scratch_

- **14h30 - 15h30**
  - Atelier Eleventy pt.2 : gestion des étiquettes et navigabilité
...
- **9h30 - 10h30**
  - Atelier Eleventy pt.3 : gestion des données à « cascade »

- **10h30 - 11h30**
  - Atelier Eleventy pt.4 : Pagination et permaliens

### Après-midi

- **12h30 - 15h30**
  - Les APIs : ou comment récupérer des données hébergés en remote
- **14h30 - 15h30**
  - Discussion finale et tour de table des rendus
