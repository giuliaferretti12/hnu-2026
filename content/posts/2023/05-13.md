...
Exercice : Créer un fichier `cv.html`. Créer un tableau « Formation », avec dans une colonne le niveau d'étude, dans l'autre colonne l'école qui vous avez fréquenté. 
...
N.B.: Pour afficher les données saisies est nécessaire faire le lien avec un serveur. On va le voir lors de notre dernière séance.

## 🛠️ Exercice 1 : De markdown a HTML avec Pandoc

<!--Per aprire nel browser : xdg-open 01-md.html -->
...
## Savais-tu qu'on pouvait faire tout ça en HTML ?
