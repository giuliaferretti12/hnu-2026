...
permalink: {% raw %} /blog/tag/{{ tag }}/ {% endraw %}
eleventyComputed:
    title:  {% raw %} Posts Tagged with {{ tag }} {% endraw %}
```
...
### Lien entre index et blog

Si vous voulez afficher le lien vers votre blog dans votre page d'accueil : 
`<a href="/blog/">Voir le blog</a>`

Si vous voulez afficher la liste des posts directement dans l'index, ajoutez quelque chose de ce type : 
